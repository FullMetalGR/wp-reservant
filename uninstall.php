 ...
 * - It drops only the thirteen `{$wpdb->prefix}reservant_*` tables and deletes only four
...
foreach ( array( 'reservant_settings', 'reservant_version', 'reservant_db_version', 'reservant_fixture_ids' ) as $reservant_option ) {
