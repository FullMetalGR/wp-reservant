 ...
 * show - the one case the widget's live-region convention reserves `role="alert"` for.
 */
...
export function RescheduleDialog( {
	...
	return (
		...
		>
			...
			{ busy ? (
				<p className="reservant-reschedule__busy" role="status">
					{ __( 'Moving your booking...', 'reservant' ) }
				</p>
			) : (
				<>
					{ availability.isPending && (
						<p className="reservant-reschedule__status" role="status">
